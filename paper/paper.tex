...
\begin{abstract}
\input{abstract}
\keywords{assume-guarantee \and compositional verification \and model checking \and model based system engineering \and AADL \and AGREE \and scheduling semantics}
\end{abstract}
